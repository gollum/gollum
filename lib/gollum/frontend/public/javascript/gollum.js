    ...
    $('#minibutton-new-page').click(function(e) {
      ...
      $.GollumDialog.init({
                            ...
                            OK: function( res ) {
                              ...
                              /* When creating a new page, set location to
                                 use - instead of %20 (URI encoded space). */
                              n = encodeURIComponent( n.replace(/ /g, "-") );
                              window.location = "/editor.html?page=" + n + "&create=true";
                            }
                          });
    });
  }
