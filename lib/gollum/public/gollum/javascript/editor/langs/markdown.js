...
var MarkDown = {
  ...
  'function-bold' :         {
                              manipulate: ['selected', 'toggleWrap', '**']
                            },

  'function-italic' :       {
                              manipulate: ['selected', 'toggleWrap', '_']
                            },

  'function-code'   :       {
                              manipulate: ['conditional', 'multiLine', {
                                single: {prefix: "`"},
                                multi: {
                                  target: "block",
                                  prefix: {
  ...
  'function-hr'     :       {
                              manipulate: ['selection', 'insert', "\n***\n"]
                            },

  'function-ul'     :       {
                              manipulate: ['lines', 'toggleWrap', '* ']
                            },
  /* based on rdoc.js */
  'function-ol'   :         {
                              manipulate: ['lines', 'toggleWrap', {
  ...
  'function-h1'         :   {
                              manipulate: ['conditional', 'matching', {
                                atxClosed: {
                                  matchOn: 'lines',
                                  match: /^# .* #$/,
                                  action: ['lines', 'unwrap', '# ', ' #']
                                ...
                                setext: {
                                  matchOn: 'block',
                                  match: /^.*\n[=]+$/,
                                  action: ['block', '_replaceRegex', new RegExp("\n[=]+$"), '']
                                },
                                default: {
                                  action: ['lines', 'toggleWrap', '# ']
                                }
                              }]
                            },
  ...
  'function-link'       :   {
                              exec: function( selText, $field ) {
                                var results = null;

                                var isStringURL = $.GollumEditor.isStringURL(selText);
                                ...
                                $.GollumEditor.Dialog.init({
                                  ...
                                  fields: [
                                    {
                                      ...
                                      name: 'Link Text',
                                      type: 'text',
                                      defaultValue: (isStringURL ? "" : selText)
                                    },
                                    {
                                      id:   'href',
                                      name: 'URL',
                                  ...
                                  OK: function( res ) {
                                    ...
                                    if ($.GollumEditor.isStringURL(res.href)) {
                                    ...
                                    if (rep) {
                                      $.GollumEditor.manipulate('selected', 'replace', rep);
                                    }
                                  }
                                });
                              }
...
$.GollumPreview.defineRenderer('markdown', {
  source: 'markdown.min',
