...
var baseUrl = "//" + location.host + location.pathname.split('/').slice(0,-2).join('/');
...
$.save = function( commitMessage ) {
  ...
  // Remove all duplicate slashes, except for the first one
  // The URL will look like //hostname:port/path/to/page/ or //hostname/path/to/page
  function clean( str ) {
